...
LEXERS = {
    ...
    'SILLexer': ('pygments.lexers.swift', 'SIL', ('sil',), ('*.sil',), ()),
    ...
    'SwiftConsoleLexer': ('pygments.lexers.swift', 'SwiftConsole', ('swift-console',), ('*.swiftc',), ()),
    'SwiftLexer': ('pygments.lexers.objective', 'Swift', ('swift',), ('*.swift',), ('text/x-swift',)),
    'SwiftLexer': ('pygments.lexers.swift', 'Swift', ('swift',), ('*.swift',), ()),
